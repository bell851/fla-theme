            ...
            <?php if ( have_posts() ) : //条件分岐：投稿があるなら ?>
                <section class="contentHead">
                    ...
                    <div class="tab flexSide">
                        <div class="halfTab"><a href="<?php echo home_url('/category/stylemens/'); ?>" class="en sexTab men gray">MEN'S</a></div>
                        <div class="halfTab"><a href="<?php echo home_url('/category/styleladies/'); ?>" class="en sexTab lad green">LADIES'</a></div>
                    </div>
                </section>
